...
var puzzle_day23_01_1 = require("./puzzle_day23_01");
var puzzle_day23_02_1 = require("./puzzle_day23_02");
function printResult() {
    console.log("--- Day 23: ---");
    try {
        var firstSolutionResult = (0, puzzle_day23_01_1.solution)();
    ...
    try {
        var secondSolutionResult = (0, puzzle_day23_02_1.solution)();
...
function getResult() {
    ...
    try {
        retVal.firstSolution = (0, puzzle_day23_01_1.solution)();
    }
    catch (error) {
        (retVal.firstSolution = "First solution:"), error.message;
    }
    try {
        retVal.secondSolution = (0, puzzle_day23_02_1.solution)();
    }
    catch (error) {
