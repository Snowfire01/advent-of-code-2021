...
var puzzle_day11_01_1 = require("./puzzle_day11_01");
var puzzle_day11_02_1 = require("./puzzle_day11_02");
function printResult() {
    console.log("--- Day 11: ---");
    try {
        var firstSolutionResult = (0, puzzle_day11_01_1.solution)();
    ...
    try {
        var secondSolutionResult = (0, puzzle_day11_02_1.solution)();
...
function getResult() {
    ...
    try {
        retVal.firstSolution = (0, puzzle_day11_01_1.solution)();
    }
    catch (error) {
        (retVal.firstSolution = "First solution:"), error.message;
    }
    try {
        retVal.secondSolution = (0, puzzle_day11_02_1.solution)();
    }
    catch (error) {
